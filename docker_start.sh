docker build -t jwpyo_image:latest .

# docker run -it -d -p 30033:22 -v /hd4/jungwoo_pyo/jungwoo_pyo:/home/jungwoo_pyo --name jwpyo_container jwpyo_image
docker run -it -d -p 30033:22 --gpus all -v /hd4/table_recognition_dataset:/hd4/table_recognition_dataset --name jwpyo_container jwpyo_image
